...
# Apify setup
API_TOKEN = 'apify_api_LAwZYdQSuc4H838OuGffoMO5dKN6yy4tnIc4'
APIFY_URL = f"https://api.apify.com/v2/acts/compass~crawler-google-places/run-sync-get-dataset-items?token={API_TOKEN}"
